...
export default function Indeed() {
    ...
    const handleSubmit = async (e) => {
        ...
        const searchJob = await axios.get(`https://cors.bridged.cc/http://jobs.github.com/positions.json?description=${e.target.search.value}&page=1`)
                    ...
                    return (
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <a href={job.company_url} target="_blank" rel="noreferrer" ><Button variant="primary">Apply Online</Button> </a>
                            </Card.Body>
                        </Card>
